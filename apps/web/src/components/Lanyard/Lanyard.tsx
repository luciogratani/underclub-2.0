...
const MOCK_TICKET: TicketData = {
  ...
  eventName: 'TECHNOROOM: GIRLS POWER',
  entry: '10 € + 1 DRINK'
};
          ...
          >
            ...
            <group scale={[0.1, 0.1, 0.1]}>
              ...
              >
                ...
                <div style={{ fontWeight: 700, textTransform: 'uppercase', marginBottom: '8px', fontSize: '20px' }}>
                  {ticketData.fullName}
                </div>
                <div style={{ opacity: 0.9, fontSize: '18px' }}>{ticketData.email}</div>
                <div style={{ marginTop: '6px', fontSize: '18px' }}>{ticketData.date}</div>
